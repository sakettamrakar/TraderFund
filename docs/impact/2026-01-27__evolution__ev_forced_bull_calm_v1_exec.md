# Documentation Impact Declaration: EV-FORCED-BULL-CALM-V1 Execution

**Date**: 2026-01-27T00:57:12.668069
**Profile ID**: EV-FORCED-BULL-CALM-V1
**Version**: 1.0.0
**Status**: SUCCESS

## Execution Summary
Execution of evaluation profile `EV-FORCED-BULL-CALM-V1` in `forced_regime` mode.

- **Window Count**: 35
- **Artifact Namespace**: `ev/forced/bull_calm/v1`
- **Shadow Only**: True

## Artifacts Generated
All artifacts are located under:
`docs/evolution/evaluation/ev/forced/bull_calm/v1/`
